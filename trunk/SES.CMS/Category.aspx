                        ...
                        <ItemTemplate>
                            <asp:Panel runat="server" id="divCategory">
                                ...
                                <div class="cate-desc-box">
                                    ...
                                    <a class="readmore" title='<%#Eval("Title") %>' href='/<%#FriendlyUrl(Eval("CategoryTitle").ToString())%>-<%#Request.QueryString["CategoryID"] %>/<%#FriendlyUrl(Eval("Title").ToString())%>-<%#Eval("ArticleID")%>.aspx'>
                                        Xem tiếp</a>
                                </asp:Panel>
                            </div>
                        </ItemTemplate>
