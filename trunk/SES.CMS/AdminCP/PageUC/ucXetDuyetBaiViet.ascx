<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucXetDuyetBaiViet.ascx.cs"
    Inherits="SES.CMS.AdminCP.PageUC.ucXetDuyetBaiViet" %>
<h2>
    Danh sách Tin tức</h2>
<div style="width: 100%; float: left; margin-bottom: 10px;">
    <div class="xd-filter">
        <span class="span-xd-category">Danh mục:
            <asp:DropDownList ID="cboCategory" runat="server" CssClass="ddl-input" AppendDataBoundItems="true">
