<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucMnuArticles.ascx.cs" Inherits="SES.CMS.AdminCP.MenuUC.ucMnuArticles" %>
<li><a href="Default.aspx?Page=ListArticleCategory">Danh mục</a></li>
