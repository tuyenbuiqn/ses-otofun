<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Child.aspx.cs" Inherits="SES.CMS.Child" %>
...
<head runat="server">
   ...
   <link href="/css/CssForDateControl/style.css" rel="stylesheet" type="text/css" />
    <script src="/js/jsForDateControl/jquery-1.8.3.js"></script>
    <script src="/js/jsForDateControl/jquery-ui.js"></script>
