<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucDuyetComment.ascx.cs" Inherits="SES.CMS.ofeditor.Module.ucDuyetComment" %>
<h2>
...
<div style="width: 100%; float: left; margin-bottom: 10px;">
    <div class="xd-filter">
        ...
        <span class="span-xd-button-filter">
            <asp:Button runat="server" CssClass="button-gg-green1" ID="btnFilter" Text="Lọc bài viết"
...
<div style="width: 100%; float: right; margin-bottom: 10px;">
        <span class="span-xd-button">
            <asp:Button runat="server" CssClass="button-gg-green1" ID="btnAccept" Text="Duyệt bài viết"
...
<div style="width: 100%; float: left; margin-top: 20px;">
    <span class="span-xd-button">
        <asp:Button runat="server" CssClass="button-gg-green1" ID="btnAccept1" Text="Duyệt bài viết"
            OnClick="btnAccept_Click" />
