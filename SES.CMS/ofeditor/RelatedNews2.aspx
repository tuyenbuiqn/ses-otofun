<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatedNews2.aspx.cs" Inherits="SES.CMS.ofeditor.RelatedNews2" %>
...
<body onload="AdjustRadWidow();">
    ...
    <legend>TÌM KIẾM TIN LIÊN QUAN</legend>
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
       <script type="text/javascript">
           ...
           function returnToParent2() {
               var oArg = new Object();
               oArg.cityName = "";
               oArg.cityName2 = document.getElementById("<%=hdfListArticlesId.ClientID%>").value;
               oArg.ID = "2";

               var oWnd2 = GetRadWindow();
    ...
    <script type="text/javascript">
        ...
        <div id="ArticlesSelect">
            ...
            <input type='button' class="inputButtom" style="margin-bottom:10px;" name = 'button' value='HOÀN THÀNH' onclick="returnToParent2(); return false;" /> 
        </div>
    </div>
    </fieldset>
    </form>
