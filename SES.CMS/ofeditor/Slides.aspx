<%@ Page Title="" Language="C#" MasterPageFile="~/ofeditor/Editor.Master" AutoEventWireup="true" CodeBehind="Slides.aspx.cs" Inherits="SES.CMS.ofeditor.Slides" %>
...
<br />
<asp:Button Visible="false" ID="btnAddImages" runat="server" onclick="btnAddImages_Click" Text="Thêm nhiều ảnh" />
</asp:Content>
