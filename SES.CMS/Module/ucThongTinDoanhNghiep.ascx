            ...
            <asp:Repeater runat="server" ID="rptThongTinDoanhNghiep">
                <ItemTemplate>
                    <div class="promo-post fl clearfix">
                        <a href='/Thong-Tin-Doanh-Nghiep-40/<%#FriendlyUrl(Eval("Title").ToString())%>-<%#Eval("ArticleID") %>.otofun'
                        ...
                        <div class="promo-post-info fl">
                           <a href='/Thong-Tin-Doanh-Nghiep-40/<%#FriendlyUrl(Eval("Title").ToString())%>-<%#Eval("ArticleID") %>.otofun'  title='<%#Eval("Title") %>' class="promo-post-title">
                                <h5>
                                    <%#Eval("Title") %></h5>
                            </a>
                            <p>
