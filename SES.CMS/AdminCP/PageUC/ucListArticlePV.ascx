<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucListArticlePV.ascx.cs" Inherits="SES.CMS.AdminCP.PageUC.ucListArticlePV" %>
<div id="MenuListArticlePV">
    <ul>
        <li class="MenuTitle">Quản lý tin bài</li>
        <li>
            <asp:HyperLink ID="hplArticleAll" runat="server">Danh sách tất cả bài viết</asp:HyperLink>
        </li>
        <li>
            <asp:HyperLink ID="hplArticleTemp" runat="server">Danh sách bài lưu tạp</asp:HyperLink>
        </li>
        <li>
            <asp:HyperLink ID="hplArticleWaitEditor" runat="server">Danh sách bài chờ biên tập</asp:HyperLink>
        </li>
        <li>
            <asp:HyperLink ID="hplArticleAdvancedSearch" runat="server">Tìm kiếm nâng cao</asp:HyperLink>
        </li>
    </ul>
</div>
<div id="ListArticlePV">
